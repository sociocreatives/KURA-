...
export class ProhibitionOrder extends React.PureComponent<Props, State> {
                ...
                <table className="testClass">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {/* <img alt="A test image" src={image as string} width="200" /> */}
                            </td>
                        </tr>
                        <tr>
                            <td>Image: URL</td>
...
export const FunctionalProhibitionOrder = React.forwardRef<ProhibitionOrder | null, Props>((props, ref) => { // eslint-disable-line max-len
    return <ProhibitionOrder ref={ref} text={props.text} />;
});